...
- **الإضافة الجماعية والإستراد**: استيراد مجموعة طلاب او مجموعة مدرسين أو حلقات لإضافتهم من ملفات Excel.
...
- يجب أن تُطوّر **منصة الويب باستخدام تقنيات خفيفة مثل Laravel أو ** بشكل اساسي بدون أطر PHP** مع واجهات مبسطة ومتوافقة مع المتصفحات الحديثة (Chrome، Firefox، Edge).
...
- **FR-1.15** يجب أن تدعم لوحة التحكم رفع ملفات Excel لإدخال بيانات جماعية للطلاب أو المعلمين، شريطة توافق التنسيق مع القالب المعتمد.
- **FR-1.16** يجب أن يُظهر النظام تقريرًا بعد كل عملية رفع يبيّن عدد الصفوف الصحيحة، الأخطاء، والمدخلات المكررة.
